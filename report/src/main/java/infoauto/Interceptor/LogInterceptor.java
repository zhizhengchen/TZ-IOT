...
public class LogInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler){
        ...
        if (isJson(request)&& StringUtils.isNotEmpty(bodyString)){
            if (handler instanceof ResourceHttpRequestHandler){
                ...
                this.logSaveForElasticSearch((HandlerMethod) handler,bodyString);
            }
            }
        return true;
    }
     ...
     * @param stringJson
     */
    public void logSaveForElasticSearch(HandlerMethod handlerMethod,String stringJson){
                ...
                if(annotation instanceof MyLog){
                    ...
                    if(null!=headerJsonObject){
                        ...
                        if (null!=type&&type.equals("business_log")){
                            ...
                            String direction="ElasticSearch";
                            //以下是封装存储多个功能
...
//                                direction+=d.getName();
//                            }
                            log.info("|{}|{}|{}|{}|{}|{}", type ,direction,version,taskId,taskType,stringJson);
                        }
                    }
//                    else{
