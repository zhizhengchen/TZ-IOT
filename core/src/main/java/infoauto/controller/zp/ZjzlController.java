 ...
 * @create 2023/5/30 8:52
 */
@RestController
@RequestMapping("zpZjzl")
@Slf4j
public class ZjzlController {
    @Value("${mom.ip}")
...
//        KafkaUtils.kafkaSendData(jsonObject,kafkaProducer,topic);
    ...
    public JSONObject transferUpload(@MyLog @RequestBody JSONObject jsonObject) {
        ...
        return ForwardUtils.postAwaitResult(momIp, "PRD_VerifyLine", jsonObject).getJSONObject("Outputs");
    }
